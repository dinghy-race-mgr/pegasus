<?php
/**
 * Templates used for results display in rm_sailor
 *
 */
...
function result_list($params = array())
{
    ...
    $rst_display = array(
        "1" => "font-weight: bold; color: black; background-color: gold",
        "2" => "font-weight: bold; color: black; background-color: silver",
        "3" => "font-weight: bold; color: white; background-color: darkgoldenred",
    );
    ...
    foreach ($params as $eventid => $event) {
        ...
        if ($event['position'] == "1" OR $event['position'] == "2" OR $event['position'] == "3") {
            $rst_style = $rst_display[$event['position']];
        }
...
EOT;
        ...
        $event_list .= <<<EOT
             <tr >
                ...
                <td class="rm-text-md rm-table-event-list text-center" style="width: 15%; margin: 10px; $rst_style"> $position</td>  
...
function result_none($params = array())
{
    ...
    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
        <div class="alert alert-warning margin-top-40">
             <h2>Sorry!</h2> <h4>Unable to get the results you requested</h4>
        </div>
    </div>
    <div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
