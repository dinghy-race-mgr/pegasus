...
$_SESSION['option_cfg'] = array(
        ...
        "tip" => "", "active" => true),
        "race" => array("label" => "XXXXX", "pagename" => "Race Registration", "url" => "race_pg.php",
            "tip" => "", "active" => true),
        "cruise" => array("label" => "XXXXX", "pagename" => "Registration", "url" => "cruise_pg.php",
            "tip" => "", "active" => true),
        ...
        "protest" => array("label" => "Submit Protest", "pagename" => "Submit Protest", "url" => "protest_pg.php",
            "tip" => "Submit a protest for this race", "active" => true),
        "hideboat" => array("label" => "Hide Boat", "pagename" => "Hide This Boat", "url" => "hideboat_sc.php", "active" => true,
