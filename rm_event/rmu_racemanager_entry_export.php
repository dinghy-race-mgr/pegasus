<?php
/*
 * rmu_racemanager_entry_export.php
 *
...
$cfg = set_config("../config/common.ini", array("rm_event"), true);
...
// get event details
$event = $db_o->run("SELECT * FROM e_event WHERE `id` = ? and active = 1", array($eid) )->fetch();
...
if ($pagestate == "init")
{
    ...
    else
    {
        ...
        $pagefields['page-main'] = $tmpl_o->get_template("racemanager_export_form", $formfields, array("action" => true, "mode" => $mode, "include" => $include));
