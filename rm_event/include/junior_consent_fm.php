...
<div class="form-floating mb-3 ms-5 gx-5">
...
<div class="form-floating mb-3 ms-5 gx-5">
    <p class="label-style">&nbsp;&nbsp;Any medical conditions the organisers should be aware of?</p>
    <textarea class="form-control" id="c-medical" name="c-medical" value="" style="height: 80px"></textarea>  
</div>

<div class="form-floating mb-3 ms-5 gx-5">
    <p class="label-style">&nbsp;&nbsp;Any dietary requirements or allergies the organisers should be aware of?</p>
