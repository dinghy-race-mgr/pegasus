...
class RESULTS
{
   ...
   public function __construct($results_file, $force)
   {
      ...
      {         
         ...
         {
            $_SESSION['error']['problem'] = "Cannot display results";
            $_SESSION['error']['symptom'] = "Results file not found on system (or not readable)";
            $_SESSION['error']['where']   = "results_construct";
            $_SESSION['error']['fix']     = "";
         }          
      }
      
      // get last n events to display
...
// everything below here needs sorting
   ...
   private function import_results()
